...
public class Insert_Customer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(Display_Customer, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 400, 80));
        ...
        kGradientPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 300, 250, 30));

        Insert_Customer_contact.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        kGradientPanel1.add(Insert_Customer_contact, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 250, 250, 30));

        jLabel18.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel18.setText("CONTACT NO.");
        jLabel18.setAlignmentY(1.0F);
        kGradientPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 250, 100, 30));

        jLabel19.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel19.setText("EMAIL ");
        jLabel19.setAlignmentY(1.0F);
        kGradientPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 210, 100, 30));

        Insert_Customer_email.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        kGradientPanel1.add(Insert_Customer_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 210, 250, 30));
        ...
        kGradientPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 90, 250, 110));

        Insert_Customer_name.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        kGradientPanel1.add(Insert_Customer_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 50, 250, 30));

        id1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        id1.setText("NAME");
        id1.setAlignmentY(1.0F);
        kGradientPanel1.add(id1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 100, 30));

        jLabel21.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel21.setText("ADDRESS");
        jLabel21.setAlignmentY(1.0F);
        kGradientPanel1.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 100, 30));
    ...
    private void Display_CustomerAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_Display_CustomerAncestorAdded
        String Banner = Display_Customer.getText();
            ...
            {
                try{
                PreparedStatement ps=FPE_DB.getConnection().prepareStatement("SELECT * FROM `customer_id` WHERE `ID` = "+id+"");
    ...
    private void Stock_Genset_UpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Stock_Genset_UpdateMouseClicked
        ...
        if(name.equals("") || address.equals("") || email.equals("") || contact.equals("")){
        ...
        else if(Banner.equals("ADD CUSTOMER") || Banner.equals("CUSTOMER SELECTED")){
           if(!Class_Supplier.AddSupplier(name, address, contact, email))
           {
            ...
            if(!Class_Supplier.UpdateSupplier(name, address, contact, email, ids))
            {
