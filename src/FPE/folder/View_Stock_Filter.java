...
import FPE.FPE_DB;
import FPE.Insert_Parts;
import FPE.Mainpage;
import FPE.Class_tables;
import FPE.folder.Class_Filter;
...
public class View_Stock_Filter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        View_stock_Filter_pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/Drawer_Btn/Default_Imge.png"))); // NOI18N
    ...
    private void Stock_Genset_DeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Stock_Genset_DeleteMouseClicked
        ...
        if(opt==0){
            if(JOptionPane.YES_NO_OPTION == JOptionPane.YES_OPTION && !Class_Filter.DeleteFilter(id) && !Class_Supplier.DeleteSupplier(ids) ){
                ...
                ct.Filter(); ct.Supplier(); dispose(); Mainpage.ss_id.setText("");
            }
        }
    ...
    private void Stock_Genset_UpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Stock_Genset_UpdateMouseClicked
        Insert_Parts iig = new Insert_Parts();
        iig.setVisible(true);

        Insert_Parts.Inventory_Display.setText("UPDATE FILTER PRODUCT");
        Insert_Parts.Insert_Parts_Date.setText(View_stock_Filter_date.getText());
        Insert_Parts.Insert_Parts_Category.setEditable(false);
        Insert_Parts.Insert_Parts_Category.setText(View_stock_Filter_id.getText());
        Insert_Parts.Insert_Parts_Brand.setText(View_stock_Filter_brand_name.getText());
        Insert_Parts.Insert_Invetory_Filter_description.setText(View_stock_Filter_description.getText());
        
        if(View_stock_Filter_type.getText().equals("FILTER")){
            Insert_Parts.Insert_Parts_Type.setSelectedIndex(1);
        }
        else if(View_stock_Filter_type.getText().equals("PARTS")){
            Insert_Parts.Insert_Parts_Type.setSelectedIndex(2);
        }
        else{
         if(View_stock_Filter_type.getText().equals("OTHER")){
            Insert_Parts.Insert_Parts_Type.setSelectedIndex(3);
            }           
        }
        ...
        Insert_Parts.Insert_Parts_Quantity.setText(View_stock_Filter_seller_price.getText());
        Insert_Parts.Insert_Parts_Price.setText(View_stock_Filter_supplier_price.getText());
        Insert_Parts.Insert_Invetory_Filter_quantity.setText(View_stock_Filter_quantity.getText());

        Insert_Parts.Insert_Filter_Supplier_id.setText(View_stock_supplier_id.getText());
        Insert_Parts.Insert_Filter_Supplier_id.setEditable(false);
        Insert_Parts.Insert_Parts_Supplier_name.setText(View_stock_supplier_name.getText());
        Insert_Parts.Insert_Parts_Supplier_Address.setText(View_stock_supplier_address.getText());
        Insert_Parts.Insert_Parts_Supplier_Email.setText(View_stock_supplier_email.getText());
        Insert_Parts.Insert_Parts_Supplier_Contact.setText(View_stock_supplier_contact.getText());
        Insert_Parts.Path.setText("");
        ImageIcon imageicon = new ImageIcon (new ImageIcon(images).getImage().getScaledInstance(Insert_Parts.Insert_Parts_Pic.getWidth(), Insert_Parts.Insert_Parts_Pic.getHeight(),Image.SCALE_SMOOTH) );
        Insert_Parts.Insert_Parts_Pic.setIcon(imageicon);
        Insert_Parts.images = images;
        dispose();
