    ...
    if(quantity.equals("") && total_price == 0)
    {
    ...
    else if(btn.equals(" FULL OUT"))
        {
               ...
               
            {
                ...
                if(!Class_Amount.FulloutUpdateQuantityAndTotal(""+Update_Sale_quantity, Update_Sale_total_price, Office_id) && !Class_Amount.HistoryUpdateQuantityAndTotal(""+Update_Sale_quantity, Update_Sale_total_price, Office_id) && !Class_Amount.StockUpdateQuantityAndTotal(""+Update_Stock_quantity, Update_Stock_total_price, Office_id))
                    {
             ...
             else if(btn.equals(" REMOVE"))
        {
                ...
                if(Update_Stock_quantity == 0)
                    {
                        if(!Class_Amount.HistoryDelete(Office_id) &&  !Class_Amount.FulloutDelete(Office_id )){
